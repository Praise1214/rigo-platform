          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="pt-4">
              ...
              <div className="space-y-3 mb-10">
                ...
                <p className="text-charcoal/90 text-2xl font-sans font-montserrat  tracking-wider">{siteConfig.phone}</p>
              </div>
            ...
            <div className='ml-20'>
              ...
              <div className="mt-8 flex gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-pill bg-green-600 hover:bg-green-700 text-white text-[11px]"
                >
